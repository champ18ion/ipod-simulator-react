...
// ------------------------------ Global Variables and Hooks Section ------------------------------------------//
    ...
    const songsMenuItems = ["Jeena Jeena", "Kaun Tujhe", "Dooriyan"];
    // These are the audio links from which we are playing Songs 
    ...
    const settingsMenuItems = ["Wallpaper", "WiFi", "Bluetooth"];
...
// ------------------------------ Handling Button Events and Changing Menu Section ----------------------------//
    ...
    function changeMenu(){
        ...
        else if(currentMenu === "WiFi" || currentMenu === "Bluetooth"){
            let toggler = document.getElementById(`toggler-${currentMenu}`);
            if(toggler.style.left){
                setIsToggled({WiFi: currentMenu === "WiFi" ? false : isToggled.WiFi, Bluetooth: currentMenu === "Bluetooth" ? false : isToggled.Bluetooth});
            }else{
                setIsToggled({WiFi: currentMenu === "WiFi" ? true : isToggled.WiFi, Bluetooth: currentMenu === "Bluetooth" ? true : isToggled.Bluetooth});
            }
        }
